...
export default function ResumeButtons({
  ...
  return (
    <div className="z-[10] p-2 md:px-2 bg-white dark:bg-gray-800 border-none md:border-r shadow-md md:shadow-xl w-full md:w-fill max-w-fit h-full flex flex-row md:flex-col items-center justify-start md:justify-center gap-1 overflow-x-scroll md:overflow-x-hidden">
      <div className="w-8">
        <ChevronLeftIcon
